<template>
    <div class="login-box">
        ...
        <!-- /.login-logo -->
        <card>
            <card-body class="login-card-body">
...
import FormCheckLabel from "../components/FormCheckLabel.vue";
